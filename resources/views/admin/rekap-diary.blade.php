{{-- resources/views/admin/rekap-diary.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
function showError() {
    ...
    list.innerHTML = `
        <div class="flex flex-col items-center py-12 text-center">
            ...
            <p class="text-plum-dark font-bold text-base mb-1">Gagal memuat data</p>
            <p class="text-plum-muted text-sm mb-4">Tidak dapat terhubung ke server</p>
            <button onclick="fetchNanny()"
                    class="flex items-center gap-2 bg-plum text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-plum-light transition-colors">
...
// ── Fetch Nannies (Admin — semua nanny) ───────────────────────────────────────
    ...
    if (list.length === 0) {
        container.innerHTML = `
            <div class="flex flex-col items-center py-12 text-center">
                ...
                <p class="text-plum-dark font-bold text-base mb-1">Belum ada data nanny</p>
                <p class="text-plum-muted text-sm">Data nanny akan muncul di sini</p>
            </div>`;
        return;
    }
