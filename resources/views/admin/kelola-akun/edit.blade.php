{{-- resources/views/admin/kelola-akun/edit.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
@php
    $u = $user;
    // Map role string → id_role integer (same as RN getRoleIdFromName)
...
<div class="phone-frame bg-plum-pale flex flex-col relative">
    ...
    <div id="loadingOverlay" class="overlay hidden">
        ...
        <p class="text-sm font-semibold text-plum">Sedang menyimpan...</p>
    </div>
    ...
    <div class="header-bg header-wave px-5 pt-10 pb-8 relative shrink-0">
        ...
        <div class="relative anim-up delay-1">
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-white text-xl font-extrabold">Ubah Data Akun</h1>
            </div>
            <p class="text-white/60 text-xs ml-12">Ubah data akun pengguna</p>
        </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto no-scrollbar px-4 pt-5 pb-10">
        <form id="mainForm" action="{{ route('admin-kelola-akun.update', $u['id_user']) }}" method="POST"
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm" style="border:1px solid rgba(243,230,250,.6);">
                ...
                {{-- Password (optional) --}}
                <div>
                    <label class="block text-sm font-semibold text-plum-dark mb-2">Password Baru</label>
                    <div class="relative">
                    ...
                    <p class="text-plum text-xs mt-1.5 italic">
...
// Client-side validation — mirrors RN validateForm()
function handleSubmit(e) {
    ...
    const password = document.getElementById('fPassword').value;   // optional
