...
<div class="anim delay-1 relative z-10 bg-[#8B46D3] bg-[url('/assets/bg-texture.png')] bg-cover bg-center
    ...
    <div class="flex flex-col items-center relative z-10">
        <div class="flex items-center justify-center bg-white rounded-full mb-4 shadow-lg"
            ...
            <ion-icon name="analytics" style="font-size:30px;color:#8B46D3;"></ion-icon>
        </div>
        <h1 class="font-bold text-white mb-1" style="font-size:24px;letter-spacing:0.5px;">Tracking</h1>
        <p style="font-size:14px;color:rgba(255,255,255,0.8);font-weight:500;">Monitor tasks & schedule per child</p>
    </div>
</div>
...
<div class="flex-1 overflow-y-auto px-[20px] pt-[24px] pb-28 bg-gradient-to-b from-[#F8F7FF] via-[#F8F7FF] to-[#D4BAEF]/50 rounded-t-[50px] -mt-[50px] relative z-20 hide-scrollbar">
    ...
    <div class="flex flex-col gap-3">
        ...
        <a href="{{ route('majikan-tracking-show', $anak['id']) }}"
           ...
           style="border-radius:16px;border:2px solid #EAE6F5;padding:16px;
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center" style="gap:12px;">
                    ...
                    <div class="flex items-center" style="gap:4px;">
                        <ion-icon name="book" style="font-size:13px;color:#8B46D3;flex-shrink:0;"></ion-icon>
                        <span style="font-size:13px;color:#8B86A5;font-weight:500;">Tasks & Schedule</span>
                    </div>
                </div>
            </div>
...
<div class="flex-1 overflow-y-auto px-[20px] pt-[24px] pb-28 bg-gradient-to-b from-[#F8F7FF] via-[#F8F7FF] to-[#D4BAEF]/50 rounded-t-[50px] -mt-[50px] relative z-20 hide-scrollbar">
    <div class="flex flex-col items-center justify-center" style="padding:80px 40px;">
        <div class="float-anim flex items-center justify-center"
            ...
            <ion-icon name="analytics-outline" style="font-size:60px;color:#C4B5FD;"></ion-icon>
        </div>
