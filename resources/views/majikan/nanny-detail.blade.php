...
<div class="sm:w-[390px] sm:min-h-[844px] sm:rounded-[44px] sm:shadow-[0_40px_80px_rgba(124,58,237,0.28),0_0_0_8px_#1a1030,0_0_0_10px_#2d1a50] sm:overflow-hidden bg-[#F0EDFB] min-h-screen flex flex-col relative">
    ...
    <div class="anim delay-1 relative z-10 bg-[#8B46D3] bg-[url('/assets/bg-texture.png')] bg-cover bg-center
        ...
        <div class="flex items-start gap-3 relative z-10">
            ...
            <div>
                ...
                <p class="text-white/70 text-xs font-semibold mt-0.5 leading-[1.3]">Complete Profile Information and<br>Experience</p>
            </div>
        </div>
    </div>
    ...
    @php
        ...
        $experienceYears = $nanny['experience_years'] ?? ($nanny['lama_pengalaman'] ?? '2');
    ...
    <div class="flex-1 overflow-y-auto px-[20px] pt-[20px] pb-28 bg-gradient-to-b from-[#F8F7FF] via-[#F8F7FF] to-[#D4BAEF]/50 rounded-t-[50px] -mt-[50px] relative z-20 hide-scrollbar space-y-4">
        ...
        <div class="section-card anim delay-2 p-5">
            ...
            @endif
                ...
                <h2 class="text-[#1E1B2E] text-[25px] font-extrabold mt-3">{{ $nanny['name'] }}</h2>
                <div class="mt-2 bg-[#EFE9FB] px-3 py-1 rounded-full flex items-center gap-1.5">
                    ...
                    <span class="text-[#8B46D3] text-[10px] font-extrabold tracking-wide uppercase">Certified Nanny</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                <div class="detail-item px-3 py-2.5 flex items-center gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-[#1E1B2E] text-[13px] font-extrabold">{{ $nanny['email'] ?? '-' }}</p>
                    </div>
                </div>
                <div class="detail-item px-3 py-2.5 flex items-center gap-3">
        ...
        <div class="section-card anim delay-4 p-5">
            ...
            <div class="space-y-2">
                ...
                <div class="detail-item px-3 py-2.5 flex items-center gap-3">
                    <div class="w-8 h-8 rounded-[8px] bg-[#FDE8EF] flex items-center justify-center shrink-0">
                        <ion-icon name="{{ ($nanny['gender'] ?? '') === 'L' ? 'male-outline' : 'female-outline' }}" style="font-size:16px;color:#EC4899;"></ion-icon>
                    </div>
                    <div class="flex-1">
                ...
                <div class="detail-item px-3 py-2.5 flex items-center gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-[#1E1B2E] text-[13px] font-extrabold">{{ $nanny['alamat'] ?? '-' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section-card anim delay-5 p-5">
            ...
            <div class="h-px bg-[#E5E1F0] mb-4"></div>

            <div class="detail-item px-3 py-2.5 flex items-center gap-3">
                @if($consultantPhoto)
                    <img src="{{ $consultantPhoto }}" alt="{{ $consultantName ?? 'Consultant' }}" class="w-8 h-8 rounded-[7px] object-cover">
                @else
                    <div class="w-8 h-8 rounded-[7px] bg-[#F3F0FD] flex items-center justify-center shrink-0">
        ...
        <div class="anim delay-5 pt-1">
            @if($consultantName)
                <a href="{{ route('chat.room', [$nanny['konsultan']['id'], 'nama' =>($consultantName)]) }}" class="btn-contact shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
                    <ion-icon name="chatbubble-ellipses-outline" style="font-size:16px;"></ion-icon>
                    <span>Contact a Consultant</span>
                </a>
            @else
                <button class="btn-contact disabled w-full">
                    <ion-icon name="chatbubble-ellipses-outline" style="font-size:16px;"></ion-icon>
                    <span>Contact a Consultant</span>
                </button>
            @endif
