...
<div class="anim delay-1 relative z-10 bg-[#8B46D3] bg-[url('/assets/bg-texture.png')] bg-cover bg-center
    ...
    <div class="flex items-center gap-3 relative z-10">
        ...
        <div>
            ...
            <p class="text-white/60 text-xs font-medium mt-0.5">Monitor your child's weekly PDF reports</p>
        </div>
    </div>
</div>
...
<div class="flex-1 overflow-y-auto px-[20px] pt-[24px] pb-28 bg-gradient-to-b from-[#F8F7FF] via-[#F8F7FF] to-[#D4BAEF]/50 rounded-t-[50px] -mt-[50px] relative z-20 hide-scrollbar">
    ...
    <div class="flex flex-col gap-3">
        ...
        <a href="{{ route('majikan-weekly-report-show', $anak['id']) }}"
           ...
           style="border-radius:16px;border:2px solid #EAE6F5;padding:16px;
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center" style="gap:12px;">
                    ...
                    <div class="flex items-center" style="gap:4px;">
                        <ion-icon name="document-text-outline" style="font-size:13px;color:#8B46D3;flex-shrink:0;"></ion-icon>
                        <span style="font-size:13px;color:#8B86A5;font-weight:500;">Reports</span>
                    </div>
                </div>
            </div>
