<div id="historyList" data-idanak="{{ $idAnak }}">
    ...
    <div class="flex flex-col items-center py-8">
        ...
        <p class="text-[#8B86A5] text-xs font-semibold">No report yet. Nanny has not generated any weekly report.</p>
    </div>
    @else
    <div class="flex flex-col gap-2">
        ...
        <div class="rounded-2xl border border-[#EAE6F5] p-3 bg-white">
            ...
            <div class="flex items-center gap-2 mt-2">
                @if($hasPdf)
                <button type="button" onclick="wrPdfOpen('{{ route('majikan-weekly-report-view', $r['id']) }}')"
                ...
                <a href="{{ route('majikan-weekly-report-download', $r['id']) }}"
