        ...
        * { -webkit-tap-highlight-color: transparent; }
        ...
        @media (min-width: 640px) {
            .phone-wrapper {
                ...
                min-height: 100vh; padding: 32px 0 60px; background: #E5E2F5;
            }
            .phone-frame {
        ...
        .hero-bg::before {
            ...
            background-color: #8B46D3; opacity: 0.60; pointer-events: none;
        }

        .pill-input {
            background: rgba(237,230,255,0.55); border: none; border-radius: 50px;
            padding: 16px 20px 16px 52px; font-size: 14px; font-weight: 600;
            color: #3D1F7A; width: 100%; outline: none;
        ...
        .btn-google {
            background: #F0EFEF; border-radius: 50px; color: #444;
            font-weight: 700; font-size: 15px; padding: 16px; width: 100%;
        ...
        .strength-bar { height: 3px; border-radius: 99px; transition: width 0.35s ease, background-color 0.35s ease; }
        ...
        .google-spinner {
            ...
            border: 2.5px solid #ccc; border-top-color: #8B46D3;
