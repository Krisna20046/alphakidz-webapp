...
<head>
    ...
    <style>
        * { -webkit-tap-highlight-color: transparent; box-sizing: border-box; }
        ...
        .picker-item { padding:10px 12px; text-align:center; border-radius:8px; cursor:pointer; margin:2px 4px; font-size:14px; color:#1E1B2E; font-weight:600; transition:background .12s; font-family:'Nunito',sans-serif; }
        .picker-item.active { background:#8B46D3; color:#fff; font-weight:800; }
...
<div class="phone-frame bg-[#F0EDFB] flex flex-col" style="max-height:100vh;position:relative;">
