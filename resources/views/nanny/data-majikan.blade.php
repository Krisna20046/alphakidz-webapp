...
<head>
    ...
    <style>
        *{-webkit-tap-highlight-color:transparent;}
        ...
        .child-card{background:#fff;border-radius:16px;padding:16px;margin-bottom:12px;border:2px solid #F3E6FA;}
        .child-row{display:flex;align-items:flex-start;margin-bottom:10px;}
        .child-row:last-child{margin-bottom:0;}
        .child-ico{width:28px;height:28px;border-radius:8px;background:#F3E6FA;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-right:10px;}
        .chat-btn{display:flex;align-items:center;justify-content:center;gap:10px;background:#7B1E5A;color:#fff;border-radius:16px;padding:16px;font-size:16px;font-weight:700;letter-spacing:.5px;cursor:pointer;border:none;width:100%;text-decoration:none;transition:opacity .15s,transform .12s;}
...
<div class="phone-frame bg-plum-pale flex flex-col" style="max-height:100vh;">
    ...
    <div class="header-bg relative flex-shrink-0"
        ...
        <div class="flex flex-col items-center anim-up d1">
            ...
            <h1 class="font-bold text-white mb-1" style="font-size:24px;letter-spacing:0.5px;">Majikan Anda</h1>
            <p style="font-size:14px;color:#F3E6FA;font-weight:500;">Informasi pemberi kerja</p>
        </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto no-scrollbar pb-16" style="padding-right:20px; padding-left:20px; padding-top:20px;">
        ...
        <div class="sec anim-up d2" style="text-align:center;padding:28px 20px;">
            ...
            @endif
            <p style="font-size:22px;font-weight:700;color:#4A0E35;margin-bottom:8px;">{{ $data['majikan_name'] }}</p>
            <div class="inline-flex items-center" style="background:#F3E6FA;padding:8px 16px;border-radius:16px;gap:6px;">
                <ion-icon name="briefcase" style="font-size:14px;color:#7B1E5A;"></ion-icon>
                <span style="font-size:13px;color:#7B1E5A;font-weight:600;">Majikan</span>
            </div>
        </div>
        ...
        <div class="sec anim-up d3">
            ...
            <div class="info-row">
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;">{{ $data['majikan_email'] ?? '-' }}</p>
                </div>
            </div>
            <div class="info-row">
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;">{{ $data['majikan_no_hp'] ?? '-' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="sec anim-up d4">
            ...
            <div class="info-row">
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;">{{ $data['majikan_tanggal_lahir'] ?? '-' }}</p>
                </div>
            </div>
            <div class="info-row">
                @php $genderL = ($data['majikan_gender'] ?? '') === 'L'; @endphp
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;">
                        {{ ($data['majikan_gender'] ?? '') === 'L' ? 'Laki-laki' : (($data['majikan_gender'] ?? '') === 'P' ? 'Perempuan' : '-') }}
                    </p>
                </div>
            </div>
            <div class="info-row">
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;">
                        @if(!empty($data['majikan_kota']) && !empty($data['majikan_provinsi']))
            ...
            <div class="info-row">
                ...
                <div class="flex-1">
                    ...
                    <p style="font-size:15px;color:#4A0E35;font-weight:500;line-height:22px;">{{ $data['majikan_alamat'] }}</p>
                </div>
            </div>
            @endif
        </div>
        ...
        {{-- Data Anak --}}
        @if(count($children) > 0)
        <div class="anim-up d5" style="margin-bottom:16px;">
            <div class="flex items-center justify-between" style="margin-bottom:12px;">
                <div class="flex items-center" style="gap:8px;">
                    <ion-icon name="people" style="font-size:20px;color:#7B1E5A;"></ion-icon>
                    <span style="font-size:16px;font-weight:700;color:#4A0E35;">Data Anak</span>
                </div>
            ...
            <div class="child-card" style="animation:slideUp .3s ease {{ $i*.07 }}s both;opacity:0;">
                {{-- Child header --}}
                <div class="flex items-center" style="margin-bottom:12px;">
                    <div style="margin-right:12px;flex-shrink:0;">
                        @if(!empty($child['foto']))
                        <img src="{{ $child['foto'] }}" alt="{{ $child['nama'] }}"
                             style="width:48px;height:48px;border-radius:24px;object-fit:cover;border:2px solid #F3E6FA;"
                             onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                        <div class="items-center justify-center hidden"
                             style="width:48px;height:48px;border-radius:24px;background:#F3E6FA;border:2px solid #F3E6FA;">
                            <ion-icon name="happy" style="font-size:20px;color:#7B1E5A;"></ion-icon>
                        </div>
                        @else
                    ...
                    <div>
                        <p style="font-size:16px;font-weight:700;color:#4A0E35;margin-bottom:4px;">{{ $child['nama'] }}</p>
                        <div class="flex items-center" style="gap:4px;">
                            <ion-icon name="{{ $childMale ? 'male' : 'female' }}" style="font-size:13px;color:#7B1E5A;"></ion-icon>
                            <span style="font-size:13px;color:#7B1E5A;font-weight:500;">
                                {{ $childMale ? 'Laki-laki' : 'Perempuan' }}
                            </span>
                        </div>
                    </div>
                </div>

                <div style="height:1px;background:#F3E6FA;margin-bottom:12px;"></div>

                {{-- Child detail --}}
                <div>
                    <div class="child-row">
                        <div class="child-ico"><ion-icon name="calendar" style="font-size:14px;color:#7B1E5A;"></ion-icon></div>
                        <div class="flex-1">
                            <p style="font-size:12px;color:#A2397B;font-weight:600;margin-bottom:2px;">Tanggal Lahir</p>
                            <p style="font-size:14px;color:#4A0E35;font-weight:500;">{{ $child['tanggal_lahir'] ?? '-' }}</p>
                        </div>
                    </div>
                    @if(!empty($child['catatan_khusus']))
                    <div class="child-row">
                        <div class="child-ico"><ion-icon name="document-text" style="font-size:14px;color:#7B1E5A;"></ion-icon></div>
                        <div class="flex-1">
                            <p style="font-size:12px;color:#A2397B;font-weight:600;margin-bottom:2px;">Catatan Khusus</p>
                            <p style="font-size:14px;color:#4A0E35;font-weight:500;line-height:18px;">{{ $child['catatan_khusus'] }}</p>
                        </div>
                    </div>
                    @endif
                    @if(!empty($child['alergi']))
                    <div class="child-row">
                        <div class="child-ico" style="background:#FEE2E2;">
                            <ion-icon name="warning" style="font-size:14px;color:#EF4444;"></ion-icon>
                        </div>
                        <div class="flex-1">
                            <p style="font-size:12px;color:#A2397B;font-weight:600;margin-bottom:2px;">Alergi</p>
                            <p style="font-size:14px;color:#4A0E35;font-weight:500;line-height:18px;">{{ $child['alergi'] }}</p>
                        </div>
                    </div>
                    @endif
                    @if(!empty($child['hobi']))
                    <div class="child-row">
                        <div class="child-ico"><ion-icon name="heart" style="font-size:14px;color:#7B1E5A;"></ion-icon></div>
                        <div class="flex-1">
                            <p style="font-size:12px;color:#A2397B;font-weight:600;margin-bottom:2px;">Hobi</p>
                            <p style="font-size:14px;color:#4A0E35;font-weight:500;line-height:18px;">{{ $child['hobi'] }}</p>
                        </div>
                    </div>
                    @endif
                </div>
        ...
        @else
        <div class="sec anim-up d5" style="text-align:center;padding:28px 20px;">
            <div class="flex items-center justify-center mx-auto"
                 style="width:80px;height:80px;border-radius:40px;background:#F3E6FA;margin-bottom:16px;">
                <ion-icon name="people-outline" style="font-size:40px;color:#B895C8;"></ion-icon>
            </div>
            <p style="font-size:16px;font-weight:700;color:#4A0E35;margin-bottom:4px;">Tidak ada data anak</p>
            <p style="font-size:13px;color:#A2397B;">Belum ada informasi anak yang terdaftar</p>
        </div>
        @endif

        {{-- Chat button --}}
        <div style="margin-top:8px;margin-bottom:16px;">
            <a href="{{ route('chat.room', ['id' => $data['id_majikan'] ?? 0]) }}" class="chat-btn">
    ...
    <div class="flex-1 flex flex-col items-center justify-center" style="padding:40px;">
        ...
        <p class="text-center" style="font-size:18px;font-weight:700;color:#4A0E35;margin-bottom:8px;">Data majikan tidak ditemukan</p>
        <p class="text-center" style="font-size:14px;color:#A2397B;">Belum ada penugasan aktif saat ini</p>
    </div>
    @endif
