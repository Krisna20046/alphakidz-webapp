{{-- resources/views/konsultan/diary.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
let currentNannyId = {{ $id_nanny ?? 'null' }}; // Nanny ID dari route
let currentAnakId = {{ $id_anak ?? 'null' }}; // ID Anak yang sedang ditampilkan
