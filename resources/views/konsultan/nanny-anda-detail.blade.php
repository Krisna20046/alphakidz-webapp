...
@push('modals')
<div id="statusModal" class="hidden fixed inset-0 z-50 flex items-end justify-center sm:items-center" style="padding-bottom: 80px;">
    ...
    <div class="modal-card relative bg-white rounded-[24px] mx-5 p-6 w-full max-w-sm shadow-[0_20px_60px_rgba(0,0,0,0.2)] z-10">
        <div class="flex flex-col items-center text-center mb-6">
            <div class="w-[68px] h-[68px] rounded-full flex items-center justify-center mb-4 {{ $isActive ? 'bg-[#FEF2F2]' : 'bg-[#F0FDF4]' }}">
